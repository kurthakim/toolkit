...
func TestTools_DownloadStaticFile(t *testing.T) {
	...
	var testTool Tools
	testTool.DownloadStaticFile(rr, req, "./testdata/pic.jpeg", "puppy.jpeg")
	res := rr.Result()
	defer res.Body.Close()

	if res.Header["Content-Length"][0] != "222308" {
...
var jsonTests = []struct {
	...
	allowUnknown bool
		...
		{name: "file too large", json: `{jack: "1"}`, errorExpected: true, maxSize: 5, allowUnknown: true},
