...
// RandomString returns a string of random characters of length n, using randomStringSource as
...
// UploadedFile is a struct used to save information about an uploaded type
